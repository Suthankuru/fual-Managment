...
public class Main {
    ...
    private static String menu() {
        ...
        System.out.println("Enter '110' or 'IFQ' What income of each Fuel queue.");
        System.out.println("Enter '111' or 'VGI' to View Graphical User Interface.");
        System.out.println("Enter the any type of code number ?  ");
